...
TIMES="10"
CHATID="6496862638"
KEY="8193503111:AAEhbyLFdAiv57QD4Wb-0Qy0B_Boq2yQ6rE"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/xresxstoresx26/izin/main/ip| grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/xresxstoresx26/izin/main/ip| grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/xresxstoresx26/izin/main/ip| grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/xresxstoresx26/vps/main/"
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/xresxstoresx26/izin/main/ip| grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/xresxstoresx26/izin/main/ip| grep $MYIP | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6283114918419"}]]}' 
